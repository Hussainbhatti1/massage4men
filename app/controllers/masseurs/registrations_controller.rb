class Masseurs::RegistrationsController < Devise::RegistrationsController
    ...
    super do
      ...
      respond_to do |format|
        if resource.persisted? && resource.active_for_authentication?
          ...
          resource.update(profile_photo: params[:profile_photo])
  ...
  def configure_sign_up_params
    devise_parameter_sanitizer.permit(sign_up: [:screen_name, :mailing_zip, :dob, :contact_phone,:show_number, :profile_photo, :tracking_link_id, ])
  end
  ...
  def update_params
    params.require(:masseur).permit(:first_name, :last_name, :screen_name, :mailing_address, :mailing_unit, :mailing_city, :mailing_state, :mailing_country, :mailing_zip, :dob, :contact_phone, :contact_phone_type, :provides_services_at_mailing_address, :profile_photo, :notify_when_availability_expires)
  end
