...
Rails.application.routes.draw do
  ...
  get 'private-policy' => 'static_pages#privacy-policy'
  get 'terms-service' => 'static_pages#terms-of-service'
  ...
  StaticPage.all.map { |p| p.slug }.each do |static_page_slug|
    get static_page_slug, controller: :static_pages, action: :show, id: static_page_slug
  end
